...
if (te_tags == undefined || te_tags.run == undefined) {
    var te_tags = {
        ...
        RunAudience: function () {
            te_tags.RenderTag('script', te_tags.domain + 'xl/PROD/TrackingTargets/fetch.cp?cache=no-cache&default=default_pl_cr.js&file=/' + te_tags.cpid + '/CrtvGroupTags/' + te_tags.cr_grp_id + '.js');
        },
